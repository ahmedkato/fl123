...
-- 
-- 	Table structure for table `costcalculator_distance`
--

ALTER TABLE `$prefix_costcalculator_distance` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_costcalculator_distance` 	CHANGE `cost_name` `cost_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `cost_unit_title` `cost_unit_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `additional_discount_unit` `additional_discount_unit` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;


-- --------------------------------------------------------

-- 
-- 	Table structure for table `costcalculator_package`
--

ALTER TABLE `$prefix_costcalculator_package` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_costcalculator_package` 	CHANGE `package_name` `package_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `availability` `availability` ENUM( '1', '0' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1',
												CHANGE `description` `description` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `not_available_date` `not_available_date` TINYTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL; 


-- --------------------------------------------------------

-- 
-- 	Table structure for table `costcalculator_plan_assign`
--

ALTER TABLE `$prefix_costcalculator_plan_assign` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_costcalculator_plan_assign` 	CHANGE `plan_title` `plan_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
													CHANGE `plan_table_name` `plan_table_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL; 


-- --------------------------------------------------------

-- 
-- 	Table structure for table `costcalculator_plan_value`
--

ALTER TABLE `$prefix_costcalculator_plan_value` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_costcalculator_plan_value` 	CHANGE `plan_table_name` `plan_table_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
													CHANGE `additional_cost_title` `additional_cost_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
													CHANGE `cost_unit_other_title` `cost_unit_other_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL; 


-- --------------------------------------------------------

-- 
-- 	Table structure for table `costcalculator_proportion`
--

ALTER TABLE `$prefix_costcalculator_proportion` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_costcalculator_proportion` 	CHANGE `cost_unit_title` `cost_unit_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
													CHANGE `additional_discount_unit` `additional_discount_unit` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
-- 
-- 	Table structure for table `costcalculator_settings`
--

ALTER TABLE `$prefix_costcalculator_settings` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_costcalculator_settings` CHANGE `google_api_client_id` `google_api_client_id` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
-- 
-- 	Table structure for table `flight_airlines`
--

ALTER TABLE `$prefix_flight_airlines` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_airlines` 	CHANGE `airlines_name` `airlines_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `airlines_hub` `airlines_hub` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `airlines_hub_city` `airlines_hub_city` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `primary_image` `primary_image` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `airlines_logo` `airlines_logo` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `airlines_code` `airlines_code` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `airlines_short_desc` `airlines_short_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
ALTER TABLE `$prefix_flight_airport` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_airport` 	CHANGE `icao_code` `icao_code` VARCHAR( 4 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `iata_code` `iata_code` VARCHAR( 4 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `airport_name` `airport_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
ALTER TABLE `$prefix_flight_api` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_api`	CHANGE `api_name` `api_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_username` `api_username` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_password` `api_password` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_key` `api_key` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_base_uri` `api_base_uri` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_ts_code` `api_ts_code` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
ALTER TABLE `$prefix_flight_flights` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_flights`	CHANGE `flight_route_name` `flight_route_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, CHANGE `flight_route_title` `flight_route_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, CHANGE `flight_code` `flight_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `flight_number` `flight_number` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, CHANGE `flight_route_desc` `flight_route_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, CHANGE `featured` `featured` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
										CHANGE `flight_route_terminal` `flight_route_terminal` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `flight_route_terminal_round` `flight_route_terminal_round` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `flight_journey_type` `flight_journey_type` ENUM('One way','Round','Multi City') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT 'Multi City', 
										CHANGE `flight_travel_class` `flight_travel_class` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `active` `active` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1';

-- --------------------------------------------------------

-- 
-- 	Table structure for table `flight_itinerary`
--

ALTER TABLE `$prefix_flight_itinerary` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_itinerary`	CHANGE `itinerary_id` `itinerary_id` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `itinerary_obj` `itinerary_obj` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `invoice_status` `invoice_status` ENUM( '0', '1', '2' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '2';

-- --------------------------------------------------------

-- 
-- 	Table structure for table `flight_price_plan`
--

ALTER TABLE `$prefix_flight_price_plan` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_price_plan` 	CHANGE `plan_name` `plan_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `origin_code` `origin_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `business_type` `business_type` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `destination_code` `destination_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `aircraft` `aircraft` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `airlines_code` `airlines_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `airlines` `airlines` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `airlines_pic` `airlines_pic` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `active` `active` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1';
...
ALTER TABLE `$prefix_flight_route` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_flight_route`	CHANGE `flight_route_departure` `flight_route_departure` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `flight_route_arrival` `flight_route_arrival` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `flight_route_departure_date` `flight_route_departure_date` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `flight_route_arrival_date` `flight_route_arrival_date` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `flight_route_journey_type` `flight_route_journey_type` ENUM( '0', '-1', '1' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '-1',
									CHANGE `flight_route_way_type` `flight_route_way_type` ENUM( 'One way', 'Round', 'Multi City' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT 'One way';
...
--
-- Table structure for table `$prefix_hotels_api`
--

DROP TABLE IF EXISTS `$prefix_hotels_api`;
CREATE TABLE IF NOT EXISTS `$prefix_hotels_api` (
  ...
  `api_base_uri` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_ts_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
ALTER TABLE `$prefix_hotels_api` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_api` 	CHANGE `api_name` `api_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_username` `api_username` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_password` `api_password` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_key` `api_key` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_base_uri` `api_base_uri` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
...
-- 
-- 	Table structure for table `hotels_business_type`
--

ALTER TABLE `$prefix_hotels_business_type` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_business_type` CHANGE `business_type` `business_type` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
ALTER TABLE `$prefix_hotels_category` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_category` 	CHANGE `category_name` `category_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `category_title` `category_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
										CHANGE `category_thumb` `category_thumb` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
...
-- 
-- 	Table structure for table `hotels_group`
--

ALTER TABLE `$prefix_hotels_group` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_group` 	CHANGE `group_name` `group_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										...
										CHANGE `cat_sort` `cat_sort` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `cat_order` `cat_order` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `latest_cat_on` `latest_cat_on` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0', 
										CHANGE `latest_cat_sort` `latest_cat_sort` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `latest_cat_order` `latest_cat_order` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `fearured_cat_on` `fearured_cat_on` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
										CHANGE `fearured_cat_sort` `fearured_cat_sort` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
...
-- 
-- 	Table structure for table `hotels_page`
--

ALTER TABLE `$prefix_hotels_page` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_page` 	CHANGE `room_type_id` `room_type_id` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_name` `hotels_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_title` `hotels_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_agent` `hotels_agent` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_primary_image` `hotels_primary_image` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_image` `hotels_image` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_status` `hotels_status` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_desc` `hotels_desc` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `related_items` `related_items` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `featured` `featured` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
									CHANGE `active` `active` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1', 
									CHANGE `meta_title` `meta_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `meta_keywords` `meta_keywords` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `meta_desc` `meta_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `location_for_search` `location_for_search` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_building_no` `hotels_building_no` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_building_name` `hotels_building_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_phone` `hotels_phone` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_fax` `hotels_fax` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_email` `hotels_email` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `post_code` `post_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_address` `hotels_address` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_pet` `feature_pet` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'Pets are sllowed, Pets are not allowed', 
									CHANGE `feature_facilities` `feature_facilities` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_sports_recreations` `feature_sports_recreations` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_primary_interior_image` `feature_primary_interior_image` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_interior_plan_image` `feature_interior_plan_image` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_google_map` `feature_google_map` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_additional` `feature_additional` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `brochure_title` `brochure_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `brochure_desc` `brochure_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_about_information` `hotels_about_information` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_about_general` `hotels_about_general` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_about_services` `hotels_about_services` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_about_internet` `hotels_about_internet` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_about_parking` `hotels_about_parking` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_about_other` `hotels_about_other` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_policy_policies` `hotels_policy_policies` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_policy_terms_condition` `hotels_policy_terms_condition` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_policy_privacy` `hotels_policy_privacy` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `hotels_policy_surroundings` `hotels_policy_surroundings` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `payment_options` `payment_options` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'Accepted Credit Card,Not Accepted Credit Card,Visa, Master,Express,Paypal', 
									CHANGE `payment_desc` `payment_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL;
...
ALTER TABLE `$prefix_hotels_room` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_room` 	CHANGE `room_name` `room_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `room_condition` `room_condition` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `room_desc` `room_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL;
...
-- 
-- 	Table structure for table `hotels_room_calendar`
--

ALTER TABLE `$prefix_hotels_room_calendar` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
-- 
-- 	Table structure for table `hotels_room_type`
--

ALTER TABLE `$prefix_hotels_room_type` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_hotels_room_type` 	CHANGE `room_type` `room_type` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `primary_image` `primary_image` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `room_type_image` `room_type_image` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `room_condition` `room_condition` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `room_desc` `room_desc` TINYTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `room_available_information` `room_available_information` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;


-- --------------------------------------------------------

-- 
-- 	Table structure for table `hotels_saved`
--

ALTER TABLE `$prefix_hotels_saved` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
--
-- Table structure for table `$prefix_vacationrentals_api`
--

DROP TABLE IF EXISTS `$prefix_vacationrentals_api`;
CREATE TABLE IF NOT EXISTS `$prefix_vacationrentals_api` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `api_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_username` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_password` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
ALTER TABLE `$prefix_vacationrentals_api` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_vacationrentals_api`	CHANGE `api_name` `api_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `api_username` `api_username` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `api_password` `api_password` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `api_key` `api_key` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
											CHANGE `api_base_uri` `api_base_uri` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
...
-- 
-- 	Table structure for table `vacationrentals_business_type`
--

ALTER TABLE `$prefix_vacationrentals_business_type` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_vacationrentals_business_type` CHANGE `business_type` `business_type` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
-- 
-- 	Table structure for table `vacationrentals_category`
--

ALTER TABLE `$prefix_vacationrentals_category` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_vacationrentals_category`	CHANGE `category_name` `category_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `category_title` `category_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `category_thumb` `category_thumb` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `category_desc` `category_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
												CHANGE `meta_title` `meta_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
...
-- 
-- 	Table structure for table `vacationrentals_expire`
--

ALTER TABLE `$prefix_vacationrentals_expire` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
-- 
-- 	Table structure for table `vacationrentals_group`
--

ALTER TABLE `$prefix_vacationrentals_group` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_vacationrentals_group`	CHANGE `vacationrentals_name` `vacationrentals_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
												CHANGE `group_type` `group_type` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
												CHANGE `calendar_on_off` `calendar_on_off` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
												CHANGE `category_on_off` `category_on_off` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1', 
												CHANGE `category_panel` `category_panel` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
...
-- 
-- 	Table structure for table `vacationrentals_page`
--

ALTER TABLE `$prefix_vacationrentals_page` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_vacationrentals_page`	CHANGE `related_items` `related_items` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `featured` `featured` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
											CHANGE `active` `active` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1', 
											CHANGE `meta_title` `meta_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `meta_keywords` `meta_keywords` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											...
											CHANGE `location_type` `location_type` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `accommodates` `accommodates` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `vacationrentals_address` `vacationrentals_address` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `feature_amenities` `feature_amenities` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `feature_other_facilities` `feature_other_facilities` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `feature_reception` `feature_reception` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `rentals_policy` `rentals_policy` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											...
											CHANGE `trams_and_condition` `trams_and_condition` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `feature_bedroom` `feature_bedroom` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `feature_distance_from_city` `feature_distance_from_city` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											...
											CHANGE `feature_others_exclusive_images` `feature_others_exclusive_images` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `feature_google_map` `feature_google_map` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `brochure_title` `brochure_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `entertainments` `entertainments` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `gusts_allowed` `gusts_allowed` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
											CHANGE `payment_desc` `payment_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
...
-- 
-- 	Table structure for table `vacationrentals_saved`
--

ALTER TABLE `$prefix_vacationrentals_saved` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
--
-- Table structure for table `$prefix_tours_api`
--

DROP TABLE IF EXISTS `$prefix_tours_api`;
CREATE TABLE IF NOT EXISTS `$prefix_tours_api` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `api_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_username` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `api_password` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
ALTER TABLE `$prefix_tours_api` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_tours_api`	CHANGE `api_name` `api_name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_username` `api_username` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_password` `api_password` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_key` `api_key` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
									CHANGE `api_base_uri` `api_base_uri` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
...
-- 
-- 	Table structure for table `tours_business_type`
--

ALTER TABLE `$prefix_tours_business_type` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_tours_business_type` CHANGE `business_type` `business_type` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ;
...
ALTER TABLE `$prefix_tours_category` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_tours_category`	CHANGE `category_name` `category_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `category_title` `category_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `category_thumb` `category_thumb` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `category_desc` `category_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
										CHANGE `meta_title` `meta_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
...
-- 
-- 	Table structure for table `tours_expire`
--

ALTER TABLE `$prefix_tours_expire` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
-- 
-- 	Table structure for table `tours_group`
--

ALTER TABLE `$prefix_tours_group` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_tours_group`	CHANGE `tours_name` `tours_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `group_type` `group_type` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `calendar_on_off` `calendar_on_off` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
									CHANGE `category_on_off` `category_on_off` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1', 
									CHANGE `category_panel` `category_panel` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
...
-- 
-- 	Table structure for table `tours_page`
--

ALTER TABLE `$prefix_tours_page` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE `$prefix_tours_page`	CHANGE `tours_name` `tours_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tours_title` `tours_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tours_operator` `tours_operator` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `traveler_photos` `traveler_photos` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tours_image` `tours_image` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tours_desc` `tours_desc` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `related_items` `related_items` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `featured` `featured` ENUM('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0', 
									CHANGE `active` `active` ENUM('1','0') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '1', 
									CHANGE `meta_title` `meta_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									...
									CHANGE `meta_desc` `meta_desc` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `post_code` `post_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `duration` `duration` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `location_type` `location_type` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `transportation` `transportation` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `inclusions` `inclusions` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `exclusions` `exclusions` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `ending_city` `ending_city` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `visiting_cities` `visiting_cities` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tour_policy` `tour_policy` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tours_code` `tours_code` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `sightseeing` `sightseeing` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `Pickup_service` `Pickup_service` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `supplementary_room` `supplementary_room` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `drop_off_service` `drop_off_service` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `trams_and_condition` `trams_and_condition` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `scheduled_on` `scheduled_on` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `extra_nights_per_person` `extra_nights_per_person` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_primary_floor_image` `feature_primary_floor_image` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `spots_photo_gallery` `spots_photo_gallery` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `feature_google_map` `feature_google_map` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `tour_highlights` `tour_highlights` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `itinerary_title` `itinerary_title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `itinerary_desc` `itinerary_desc` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `entertainments` `entertainments` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `starting_city` `starting_city` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
									CHANGE `multilingual_guide` `multilingual_guide` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL, 
...
-- 
-- 	Table structure for table `tours_saved`
--

ALTER TABLE `$prefix_tours_saved` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;